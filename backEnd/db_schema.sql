...
CREATE TABLE INTERESTS (
	InterestTitle CHAR(30) UNIQUE NOT NULL,
	
	PRIMARY KEY(InterestTitle)
);

CREATE TABLE SIMILAR_INTERESTS (
	firstInterest CHAR(30) NOT NULL,
	secondInterest CHAR(30) NOT NULL,
...
CREATE TABLE STUDENT_INTERESTS (
	...
	InterestTitle CHAR(30) NOT NULL,
...
/*CREATE TABLE INTEREST_CLASSES (
	InterestClass CHAR(20) NOT NULL,
	InterestTitle CHAR(20) UNIQUE NOT NULL,
	
	PRIMARY KEY(InterestClass),
